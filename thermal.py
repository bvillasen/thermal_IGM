...
# input_dir  = data_dir + 'cosmo_sims/rescaled_P19/1024_50Mpc_modified_gamma_sigmoid/'
...
# uvb_parameters = { 'scale_He':0.44, 'scale_H':0.78, 'delta_z_He':0.27, 'delta_z_H':0.05 } 
...
output_file_name = output_dir + 'solution_modified_Gamma_sigmoid.h5'
